...
function card.newEnhancedDeck()
    for i=1,4 do
        for j=1,13 do
            table.insert(card.fdeck,{rank=j,suite=i,mod=love.math.random()>.3 and love.math.random(0,8) or 0,seal=love.math.random()>.85 and love.math.random(3,4) or 0,edit=love.math.random()>.93 and love.math.random(1,3) or 0,bounce=0})
